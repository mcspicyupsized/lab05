...
`![View of connection](C:\Users\itsss\Desktop\lab05\lab05\Pictures\1.png)`
`![View of spreadsheet](C:\Users\itsss\Desktop\lab05\lab05\Pictures\table.png)`
...
WITH CountryData AS (
    SELECT
        ...
        p.country_code,
        p.year_2021 AS Population,
        i.year_2021 AS Indicator_Value
    FROM indicators i
    JOIN population p ON i.country_code = p.country_code
    JOIN country_codes c ON p.country_code = c.country_code
    WHERE i.year_2021 IS NOT NULL AND p.year_2021 IS NOT NULL
),
RankedData AS (
    SELECT
        country_name,
